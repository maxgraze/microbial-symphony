...
//   useEffect(() => {
//     if (!data) return; // Properly handle missing data without returning JSX

//     const setupAudioComponents = async () => {
//       // Assuming all necessary audio setup that depends on `data` goes here
//       console.log("Setting up audio components with data:", data);
...
//     try {
//       // Setup signal chain
//       compressor.chain(limiter, volume, Tone.Destination);

//       // If all is well, signal that setup is complete
//       setInitialized(true);
//     } catch (error) {
//       console.error("Failed to setup audio chain:", error);
//       // Handle initialization error (e.g., update state to show error message)
//     }

//     // Cleanup function to disconnect and dispose resources when component unmounts
//     return () => {
